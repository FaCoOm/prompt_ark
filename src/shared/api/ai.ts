import type { Provider, GeminiProvider, OpenAIProvider, GeminiWebProvider } from '../types/provider';
...
export async function callCloudAPI(text: string, lang: 'zh' | 'en'): Promise<MetadataResult | null> {
...
async function callGeminiAPI(provider: GeminiProvider, userContent: string, lang: 'zh' | 'en'): Promise<MetadataResult | null> {
...
async function callOpenAIAPI(provider: OpenAIProvider, userContent: string, lang: 'zh' | 'en'): Promise<MetadataResult | null> {
  const systemPrompt = lang === 'zh' 
