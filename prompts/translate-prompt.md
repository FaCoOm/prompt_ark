...
3. Preserve Technical Jargon: Words like "system prompt", "JSON", "API", or specific programming languages should remain in English if that is standard practice in the target language.
4. Natural Tone: The translation should sound natural and professional for an AI user in the target language.
