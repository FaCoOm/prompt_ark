...
export class QwenAdapter extends BasePlatformAdapter {
  readonly config: PlatformConfig = {
    name: 'qwen',
    matches: ['https://tongyi.aliyun.com/*', 'https://qwen.ai/*'],
    selectors: {
      messageContainer: ['[class*="chat"]', '[class*="conversation"]', 'main'],
      inputArea: ['div[contenteditable="true"][class*="editor"]', 'div[contenteditable="true"]', 'textarea'],
