...
INSERT INTO public.prompts (title, content, description, category, tags, author, language, type, quality_score, upvotes, install_count, variable_count, token_estimate) VALUES
...
Start by showing me an empty sheet.$$, 'You are a text-based spreadsheet engine. Reply ONLY with a 10-row table (columns A–L, row numbers in...', 'Productivity', ARRAY['excel','spreadsheet','data'], 'prompt-ark', 'en', 'prompt', 70, 40, 49, 0, 75),
...
{...', 'Productivity', ARRAY['finance','accounting','budget'], 'prompt-ark', 'en', 'prompt', 70, 30, 158, 1, 98),
...
{{project_descrip...', 'Productivity', ARRAY['project','management','planning'], 'prompt-ark', 'en', 'prompt', 71, 23, 127, 1, 106),
...
Output exactly this forma...', 'Productivity', ARRAY['meeting','summary','notes'], 'prompt-ark', 'en', 'prompt', 71, 25, 35, 1, 89),
...
Requirements:
- Subject line (...', 'Productivity', ARRAY['email','communication','business'], 'prompt-ark', 'en', 'prompt', 72, 22, 155, 2, 97),
...
For each quadrant (Strengths, Weaknesses, Opportunities, T...', 'Productivity', ARRAY['analysis','strategy','business'], 'prompt-ark', 'en', 'prompt', 72, 20, 119, 1, 104),
...
{{re...', 'Productivity', ARRAY['resume','career','job'], 'prompt-ark', 'en', 'prompt', 73, 11, 60, 2, 121),
...
Rules:
- Detect...', 'Writing', ARRAY['translation','english','grammar'], 'prompt-ark', 'en', 'prompt', 73, 33, 24, 1, 86),
...
Evaluate on 5 dimensions (rate each 1-...', 'Writing', ARRAY['writing','tutor','feedback'], 'prompt-ark', 'en', 'prompt', 74, 5, 23, 1, 116),
...
Structure:
- **Headline**: Attention-grabbing, unde...', 'Writing', ARRAY['blog','SEO','content'], 'prompt-ark', 'en', 'prompt', 74, 48, 83, 1, 133),
...
Product/Service: {{product}}
Target Audience: {{audience}...', 'Writing', ARRAY['copywriting','marketing','ads'], 'prompt-ark', 'en', 'prompt', 75, 28, 103, 2, 115),
...
Requirements:
- 800-1200 words
-...', 'Writing', ARRAY['story','narrative','creative'], 'prompt-ark', 'en', 'prompt', 75, 23, 36, 1, 95),
...
For each finding, use this...', 'Coding', ARRAY['review','quality','best-practices'], 'prompt-ark', 'en', 'prompt', 76, 20, 149, 1, 110),
...
...', 'Coding', ARRAY['api','documentation','technical'], 'prompt-ark', 'en', 'prompt', 76, 29, 116, 1, 107),
...
Follow this diagnostic process:
1. **Reproduce**: Identify t...', 'Coding', ARRAY['debug','troubleshoot','fix'], 'prompt-ark', 'en', 'prompt', 77, 36, 180, 1, 113),
...
Output:
1. **Architecture Diagram** (text-based, sho...', 'Coding', ARRAY['architecture','system-design','IT'], 'prompt-ark', 'en', 'prompt', 77, 44, 36, 1, 109),
...
For each step:
1. State what yo...', 'Education', ARRAY['math','teaching','explanation'], 'prompt-ark', 'en', 'prompt', 78, 20, 146, 1, 100),
...
Rules:
- Speak to me in {{target_language}}...', 'Education', ARRAY['language','learning','bilingual'], 'prompt-ark', 'en', 'prompt', 78, 29, 140, 1, 117),
...
1. Reply naturally (100 words ma...', 'Education', ARRAY['english','speaking','practice'], 'prompt-ark', 'en', 'prompt', 79, 8, 56, 0, 124),
...
Rules:
- Use {{character}}''s ...', 'Creative', ARRAY['roleplay','character','fiction'], 'prompt-ark', 'en', 'prompt', 79, 24, 202, 2, 101),
...
Structure:
- **Rating**: X/10
- **One-Line Verdict**: (for peop...', 'Creative', ARRAY['movie','review','film'], 'prompt-ark', 'en', 'prompt', 80, 16, 175, 1, 104),
...
For each name, provide:
| Name | Type | Why It Wor...', 'Creative', ARRAY['branding','naming','startup'], 'prompt-ark', 'en', 'prompt', 80, 2, 148, 1, 120),
...
Provide:
1. **Top 5 Must-Visit**: Name, why it''s special, best...', 'Lifestyle', ARRAY['travel','tourism','guide'], 'prompt-ark', 'en', 'prompt', 81, 29, 203, 1, 109),
...
Fo...', 'Lifestyle', ARRAY['cooking','recipe','food'], 'prompt-ark', 'en', 'prompt', 81, 39, 127, 1, 108),
...
Help me by:
1. **Reframe**: Help me see this situation from 2 ne...', 'Lifestyle', ARRAY['coaching','goals','self-improvement'], 'prompt-ark', 'en', 'prompt', 82, 49, 151, 1, 115),
...
Provide evidence-based strategies:
1. **Immediate Relief** (next 5 ...', 'Lifestyle', ARRAY['mental-health','wellness','therapy'], 'prompt-ark', 'en', 'prompt', 82, 26, 170, 1, 124),
...
Approach:
1. **Mirror**: Restate both ...', 'Lifestyle', ARRAY['relationship','communication','advice'], 'prompt-ark', 'en', 'prompt', 83, 21, 108, 1, 118),
...
Provide a compar...', 'Lifestyle', ARRAY['shopping','budget','recommendations'], 'prompt-ark', 'en', 'prompt', 83, 11, 188, 2, 102),
...
Design a 30-day plan using behavioral science:
1. **Cue**: Whe...', 'Lifestyle', ARRAY['habits','productivity','self-improvement'], 'prompt-ark', 'en', 'prompt', 84, 6, 187, 1, 141),
...
For EACH side:
1. **Core clai...', 'Analysis', ARRAY['debate','argument','analysis'], 'prompt-ark', 'en', 'prompt', 84, 32, 46, 1, 119),
...
Provide:
1. **Key Patterns**: Top 3 trends or correlations
2. **Outlie...', 'Analysis', ARRAY['data','analytics','statistics'], 'prompt-ark', 'en', 'prompt', 85, 28, 200, 1, 128),
...
Framework:
1. **User Persona**: Who has this problem?...', 'Analysis', ARRAY['product','strategy','evaluation'], 'prompt-ark', 'en', 'prompt', 85, 45, 63, 1, 140),
...
Report structure:
1. **Market Size**: TAM/SAM/SOM with so...', 'Analysis', ARRAY['market','research','industry'], 'prompt-ark', 'en', 'prompt', 86, 18, 128, 1, 115),
...
Provide:
1. **Key Legal Issues**: What laws/regulation...', 'Analysis', ARRAY['legal','law','advice'], 'prompt-ark', 'en', 'prompt', 86, 47, 198, 1, 133),
...
Analysis:
- **Rating**: ✅ True | ⚠️ Partially True | ❌ False | 🔍 U...', 'Analysis', ARRAY['fact-check','verification','truth'], 'prompt-ark', 'en', 'prompt', 87, 3, 86, 1, 118),
...
Build a comparison matrix:
| Feature/Criterion |...', 'Analysis', ARRAY['competitive','comparison','strategy'], 'prompt-ark', 'en', 'prompt', 87, 3, 176, 1, 117),
...
Structure:
1. **Core Thesis**: The book''s main argument in 2 se...', 'Analysis', ARRAY['book','analysis','reading'], 'prompt-ark', 'en', 'prompt', 88, 36, 82, 1, 121),
...
Optimiza...', 'AI & Prompting', ARRAY['prompt','optimization','engineering'], 'prompt-ark', 'en', 'prompt', 88, 15, 21, 1, 131),
...
Output a ready-to-use system prompt contain...', 'AI & Prompting', ARRAY['persona','system-prompt','design'], 'prompt-ark', 'en', 'prompt', 89, 8, 136, 1, 121),
...
The prompt must follow these principles:
- S...', 'AI & Prompting', ARRAY['prompt','generation','chatgpt'], 'prompt-ark', 'en', 'prompt', 89, 31, 154, 1, 104),
...
Do NOT start with "This article discusses..." — jump straight into the key takeaways.$$, 'Summarize this webpage in 3-5 bullet points. Each bullet should be a complete insight, not just a to...', 'Context Grabber ★', ARRAY['summary','page','context'], 'prompt-ark', 'en', 'prompt', 90, 10, 170, 3, 64),
...
{{selected_text...', 'Context Grabber ★', ARRAY['translate','selection','language'], 'prompt-ark', 'en', 'prompt', 90, 19, 178, 2, 50),
...
Use: simple...', 'Context Grabber ★', ARRAY['explain','simple','page'], 'prompt-ark', 'en', 'prompt', 91, 21, 138, 2, 68),
...
Source: {{page_title}}...', 'Context Grabber ★', ARRAY['facts','extract','data'], 'prompt-ark', 'en', 'prompt', 91, 49, 170, 3, 80),
...
Requirements:
- Max 26...', 'Context Grabber ★', ARRAY['tweet','social','marketing'], 'prompt-ark', 'en', 'prompt', 92, 13, 203, 2, 67),
...
Check: bugs, securit...', 'Context Grabber ★', ARRAY['code-review','selection','debug'], 'prompt-ark', 'en', 'prompt', 92, 1, 164, 1, 64),
...
Page: {{page_title}} ({{page_url}})
Co...', 'Context Grabber ★', ARRAY['question','page','context'], 'prompt-ark', 'en', 'prompt', 93, 6, 122, 4, 70),
...
Format:
## ...', 'Context Grabber ★', ARRAY['study','notes','education'], 'prompt-ark', 'en', 'prompt', 93, 39, 60, 2, 106),
...
Evaluate:
1. **Argume...', 'Context Grabber ★', ARRAY['critique','analysis','article'], 'prompt-ark', 'en', 'prompt', 94, 22, 146, 3, 121),
...
Rules:
- Preserve all original...', 'Context Grabber ★', ARRAY['rewrite','clarity','editing'], 'prompt-ark', 'en', 'prompt', 94, 1, 27, 1, 88),
...
输出格式：
## 本周完成
- [列出 3-5 项，每项用"动词+量化成果"格...', '职场效率', ARRAY['周报','工作','汇报'], 'prompt-ark', 'zh', 'prompt', 95, 49, 70, 1, 56),
...
输出格式：
**O (Objective)**：[鼓舞人心但具体的目...', '职场效率', ARRAY['OKR','目标','管理'], 'prompt-ark', 'zh', 'prompt', 95, 47, 102, 2, 72),
...
| 序号 | 决议事项...', '职场效率', ARRAY['会议','纪要','记录'], 'prompt-ark', 'zh', 'prompt', 70, 12, 207, 1, 51),
...
结构：
1. **开场**（2句话，直接点明核心贡献，不要写"感谢...', '职场效率', ARRAY['述职','报告','总结'], 'prompt-ark', 'zh', 'prompt', 70, 41, 154, 2, 68),
('商务邮件撰写', $$撰写一封商务邮件：
...
- 主题行：准确概括，不超过 15 个字
- 称呼：根据关系选择合适的称呼
- 正文：3 段...', '职场效率', ARRAY['邮件','商务','沟通'], 'prompt-ark', 'zh', 'prompt', 71, 27, 153, 2, 54),
...
输出：
**行为面试题**（3 题）：
每题格式：问题 + 考察维度 + 优秀回答要点 ...', '职场效率', ARRAY['面试','招聘','HR'], 'prompt-ark', 'zh', 'prompt', 71, 33, 129, 2, 61),
...
分析框架：
| 维度 | 我方 | 竞品A | 竞品B |
|---|---|---...', '职场效率', ARRAY['竞品','分析','策略'], 'prompt-ark', 'zh', 'prompt', 72, 0, 100, 2, 69),
...
标题要求：
- 每个标题不超过 22 个字（微信标题最佳长度）
- 运用至少 3 种...', '中文写作', ARRAY['标题','公众号','自媒体'], 'prompt-ark', 'zh', 'prompt', 72, 8, 96, 2, 67),
('小红书笔记撰写', $$撰写一篇小红书种草笔记：
...
**正文**（300-500 字）：
- 第一人称真实体验感
- 分段短句，每...', '中文写作', ARRAY['小红书','种草','社交媒体'], 'prompt-ark', 'zh', 'prompt', 73, 27, 206, 1, 57),
...
1. **用词精准**：替换模糊/口语化用词为更精确的书面表达
2. **句式优化**：长句拆短，消除冗余，增加节奏感
3. **逻...', '中文写作', ARRAY['润色','写作','文笔'], 'prompt-ark', 'zh', 'prompt', 73, 25, 12, 1, 55),
...
- 研究方法（1-2 句）
- 主要发现（2-3 句）
- 研究意义（1 ...', '中文写作', ARRAY['论文','摘要','学术'], 'prompt-ark', 'zh', 'prompt', 74, 37, 148, 1, 57),
...
**版本 B — ...', '中文写作', ARRAY['改写','文案','风格'], 'prompt-ark', 'zh', 'prompt', 74, 24, 69, 1, 57),
('朋友圈文案', $$写一条朋友圈文案：
...
- 风格选择（根据场景自动判断）：
  * 生活记录：温暖真实
  * 工作成就：低调但有分量
  ...', '中文写作', ARRAY['朋友圈','文案','社交'], 'prompt-ark', 'zh', 'prompt', 75, 42, 19, 1, 52),
('短视频脚本', $$撰写一个短视频脚本：
...
脚本格式：
| 时间 | 画面描述 | 台词/旁白 | 字幕文案 | ...', '中文写作', ARRAY['短视频','脚本','抖音'], 'prompt-ark', 'zh', 'prompt', 75, 16, 16, 3, 63),
('费曼学习法教练', $$用费曼学习法帮我理解：
...
1. **简单解释**：用一个 12 岁孩子能听懂的方式解释这个概念（2-3 句话）
2. **类比**：用一个日常生活中的例子来类比
3....', '学习教育', ARRAY['费曼','学习','理解'], 'prompt-ark', 'zh', 'prompt', 76, 35, 121, 1, 58),
...
输出：
1. **知识地图**：用树状结构展示这些知识点的层级关系
2. **核心主线**：贯穿所有知识...', '学习教育', ARRAY['知识','体系','串联'], 'prompt-ark', 'zh', 'prompt', 76, 4, 197, 1, 62),
('错题分析师', $$分析我的这道错题：
...
分析：
1. **错误类型**：概念错误 / 计算错误 /...', '学习教育', ARRAY['错题','分析','学习'], 'prompt-ark', 'zh', 'prompt', 77, 38, 201, 3, 67),
('考试冲刺规划', $$帮我制定考试冲刺计划：
...
输出：
1. **优先级矩阵**：将考点按"分值权重 × 我的掌...', '学习教育', ARRAY['考试','冲刺','规划'], 'prompt-ark', 'zh', 'prompt', 77, 42, 61, 3, 67),
('英语作文批改', $$批改以下英语作文：
...
1. **内容与论点** (Content)
2. **结构与组织** (Organization)
3. **语法与拼写...', '学习教育', ARRAY['英语','作文','批改'], 'prompt-ark', 'zh', 'prompt', 78, 34, 165, 1, 70),
('古诗文解读', $$深度解读这首古诗/文言文：
...
1. **逐句译注**：每句的现代文翻译 + 关键字词注释
2. **写作背景**：作者何时何地为何而作
3. **意象分析**：诗中核心...', '学习教育', ARRAY['古诗','文言文','国学'], 'prompt-ark', 'zh', 'prompt', 78, 13, 151, 1, 54),
...
- 关键点
### 二级分支1.2
...', '学习教育', ARRAY['思维导图','整理','框架'], 'prompt-ark', 'zh', 'prompt', 79, 21, 24, 1, 55),
...
输出：
1. **需求拆解**
| 功能点 | 用户故事 (As a... I want....', '编程开发', ARRAY['需求','PRD','分析'], 'prompt-ark', 'zh', 'prompt', 79, 21, 77, 1, 83),
...
**逐段解析**：
```
[代码行]  /...', '编程开发', ARRAY['代码','解释','学习'], 'prompt-ark', 'zh', 'prompt', 80, 30, 106, 2, 69),
('报错诊断专家', $$诊断以下报错信息：
...
诊断输出：
1. **错误类型**：这是什么类型的错误？（语法/运行时/逻辑/环境）...', '编程开发', ARRAY['报错','诊断','debug'], 'prompt-ark', 'zh', 'prompt', 80, 47, 107, 2, 71),
('技术方案评审', $$评审以下技术方案：
...
| 维度 | 评分 | 评审意见 |
|---|---|---|
| 可行性 | | ...', '编程开发', ARRAY['技术','评审','方案'], 'prompt-ark', 'zh', 'prompt', 81, 32, 94, 1, 69),
...
输出格式（Conventional Commits）：
```
<type>(<scope>...', '编程开发', ARRAY['git','commit','规范'], 'prompt-ark', 'zh', 'prompt', 81, 31, 58, 1, 99),
...
**认证**：[是否需要...', '编程开发', ARRAY['API','接口','文档'], 'prompt-ark', 'zh', 'prompt', 82, 20, 70, 3, 79),
('菜谱推荐', $$根据以下条件推荐一道菜：
...
输出格式：
**🍳 {{菜名}}** | ⏱...', '生活助手', ARRAY['做饭','菜谱','美食'], 'prompt-ark', 'zh', 'prompt', 82, 5, 76, 5, 68),
('旅行攻略生成', $$为我规划旅行攻略：
...
输出：
**Day 1 - Day N ...', '生活助手', ARRAY['旅行','攻略','规划'], 'prompt-ark', 'zh', 'prompt', 83, 32, 147, 4, 70),
('健康饮食顾问', $$根据我的情况设计饮食方案：
...
输出一日三餐方案（7天轮换）：
| 餐次 | 食物 | 热量 | 蛋白质 | 碳水 | 脂肪 |
|---|---|---|---|--...', '生活助手', ARRAY['饮食','健康','营养'], 'prompt-ark', 'zh', 'prompt', 83, 43, 170, 1, 70),
...
|---|---|---|
| 地段与通勤 | | |
| 户型与采光...', '生活助手', ARRAY['房产','租房','买房'], 'prompt-ark', 'zh', 'prompt', 84, 29, 198, 1, 68),
('送礼推荐师', $$帮我推荐合适的礼物：
...
推荐 5 个礼物方案，从最推荐到兜底...', '生活助手', ARRAY['送礼','推荐','人情'], 'prompt-ark', 'zh', 'prompt', 84, 37, 33, 4, 63),
...
**逐条审查**：
| 条款 | 风险等级 |...', '生活助手', ARRAY['合同','审查','法律'], 'prompt-ark', 'zh', 'prompt', 85, 8, 107, 1, 68),
...
输出 7 天选题表：
| 日期 | 选题 | 切入角度 | 内...', '自媒体', ARRAY['选题','内容','策划'], 'prompt-ark', 'zh', 'prompt', 85, 14, 40, 3, 69),
('用户评论回复', $$为以下用户评论生成回复：
...
**策略 A — 专业解答型**
[直接回...', '自媒体', ARRAY['评论','回复','运营'], 'prompt-ark', 'zh', 'prompt', 86, 15, 146, 3, 59),
...
1. **核心指标表现**：
| 指标 | 本期 | 上期 | 变化率 | 行业基准 |
|---|---|---|---|-...', '自媒体', ARRAY['数据','分析','运营'], 'prompt-ark', 'zh', 'prompt', 86, 45, 118, 1, 74),
...
输出：
1. **人设定位**（1 ...', '自媒体', ARRAY['人设','品牌','定位'], 'prompt-ark', 'zh', 'prompt', 87, 7, 95, 3, 80),
...
分析维度：
1. **标题/封面解剖**：用了什么钩子技法？
2. **内容...', '自媒体', ARRAY['爆款','分析','方法论'], 'prompt-ark', 'zh', 'prompt', 87, 15, 135, 3, 74),
...
1. **打碎假设**：列出人们对这个问题通常有哪些默认假设
2. **追问本质**：连续问 5 个"为什么"，追到最底层的事实
...', '思维工具', ARRAY['第一性原理','思考','分析'], 'prompt-ark', 'zh', 'prompt', 88, 6, 109, 1, 60),
('逆向思维教练', $$用逆向思维分析这个问题：
...
逆向分析过程：
1. **反转目标**：如果我想让这件事「彻底失败」，我应该怎么做？（列出 5 条"保证失败"的做法）
2. **避免清单**：...', '思维工具', ARRAY['逆向','思维','决策'], 'prompt-ark', 'zh', 'prompt', 88, 4, 108, 1, 62),
('六顶思考帽', $$用六顶思考帽方法全面分析：
...
**⚪ 白帽（事实）**：客观数据和已知事实是什么？
**🔴 红帽（直觉）**：你的直觉和情绪反应是什么？不需要理由
**⚫ 黑帽（谨慎）**：风...', '思维工具', ARRAY['六顶帽','决策','分析'], 'prompt-ark', 'zh', 'prompt', 89, 17, 26, 1, 60),
...
|---|---|---|
| **What** | 要做什么？核心目标是？ | |
| **Why*...', '思维工具', ARRAY['5W2H','分析','框架'], 'prompt-ark', 'zh', 'prompt', 89, 9, 139, 1, 90),
('复盘教练', $$帮我对以下事件进行结构化复盘：
...
2. **Res...', '思维工具', ARRAY['复盘','反思','总结'], 'prompt-ark', 'zh', 'prompt', 90, 26, 159, 1, 83),
...
步骤：
1. **寻找类比**：从完全不同的领域找 3 个与此问题结构相似的情境
2. **映射关系**：画出原问题和类比情境之间的对...', '思维工具', ARRAY['类比','跨界','创新'], 'prompt-ark', 'zh', 'prompt', 90, 32, 174, 1, 72),
('成语故事讲解', $$深度讲解这个成语：
...
1. **字面解释**：每个字的原始含义
2. **典故出处**：原始故事（用生动的叙事而非百科式罗列）
3. **含义演变**：从古到今，含义发生...', '国学文化', ARRAY['成语','故事','文化'], 'prompt-ark', 'zh', 'prompt', 91, 39, 203, 1, 53),
('对联创作', $$创作一副对联：
...
提供 3 副不同风格的对联：
1. **典雅古风**：...', '国学文化', ARRAY['对联','创作','传统'], 'prompt-ark', 'zh', 'prompt', 91, 49, 105, 1, 52),
...
规则：
- {{historical_figure}}的语言风格要忠实于其时代和性格
- 适度引用其真实的名...', '国学文化', ARRAY['对话','历史','人物'], 'prompt-ark', 'zh', 'prompt', 92, 12, 90, 2, 60),
...
- 避免直白说理，要"言有尽而意无穷"
- 至少使用 1 个通感或化用前人佳句
- ...', '国学文化', ARRAY['诗词','创作','格律'], 'prompt-ark', 'zh', 'prompt', 92, 5, 47, 2, 61),
...
| 序号 | 典故/名言 | 出处 | 原文含义 | 在此场景如何使用 | 使用示...', '国学文化', ARRAY['典故','名言','应用'], 'prompt-ark', 'zh', 'prompt', 93, 13, 72, 1, 57),
...
任务 2 — 语...', '国学文化', ARRAY['文言文','翻译','仿写'], 'prompt-ark', 'zh', 'prompt', 93, 4, 190, 2, 61);