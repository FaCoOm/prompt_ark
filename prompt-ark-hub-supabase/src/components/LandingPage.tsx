...
const landingCopy = {
  en: {
    ...
    stats: [
      ...
      { label: 'Sync Your Way', text: 'Local-only, WebDAV, or Obsidian Vault sync' },
    ],
    ...
    workflowSteps: [
      ...
      },
      {
        ...
        text: 'Keep your library portable with WebDAV, Obsidian Vault sync, or community sharing through the Hub.',
      },
    ],
  ...
  zh: {
    ...
    stats: [
      ...
      { label: '同步方式', text: '支持仅本地、WebDAV 与 Obsidian Vault 同步' },
    ],
    sectionKicker: '核心能力',
    ...
    workflowSteps: [
      ...
      {
        title: '同步与分享',
        text: '通过 WebDAV、Obsidian Vault 同步或 Hub 社区，让提示词在不同场景中持续复用。',
      },
    ],
