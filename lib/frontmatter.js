...
export async function promptToMarkdown(prompt, locale = 'zh_CN') {
  ...
  if (prompt.manual_custom_category) meta.manual_custom_category = true;
...
export function markdownToPrompt(markdown, filename = '') {
  ...
  return {
    ...
    manual_custom_category: meta.manual_custom_category === true || meta.manual_custom_category === 'true',
