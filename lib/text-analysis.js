...
export function buildDeferredMetadata(text, metadata = {}) {
    ...
    const heuristicCategory = matchCategory(text, heuristicLang);

    const providedTitle = normalizeTextValue(metadata.title);
    const providedCategory = normalizeTextValue(metadata.category);
    ...
    const categoryAutoGenerated = metadata.categoryAutoGenerated ?? !providedCategory;

    return {
        title: titleAutoGenerated ? heuristicTitle : providedTitle,
        category: categoryAutoGenerated ? heuristicCategory : providedCategory,
        tags: normalizedTags,
        titleAutoGenerated,
        categoryAutoGenerated,
    };
}
...
export function shouldEnrichPromptMetadata(prompt) {
    ...
    const category = normalizeTextValue(prompt.category);
