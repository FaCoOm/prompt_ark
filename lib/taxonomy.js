...
export async function migratePromptCategoryFields(prompt = {}, options = {}) {
  ...
  if (Boolean(migrated.needs_category_review) && migrated.category_type && migrated.category_type !== CATEGORY_TYPE_PENDING) {
    migrated.category_type = CATEGORY_TYPE_PENDING;
  }
