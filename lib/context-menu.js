...
function filterPromptsForContextMenu(prompts, tabUrl) {
    if (isAIChatUrl(tabUrl)) return prompts;
...
async function _doBuildContextMenus(getPromptsFn, options = {}) {
    try {
        ...
        const prompts = filterPromptsForContextMenu(await getPromptsFn(), tabUrl);
