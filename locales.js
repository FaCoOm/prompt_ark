...
export const translations = {
    zh_CN: {
        ...
        recentlyAdded: "最近添加",
        recentlyUsed: "最近使用",
        summaryAllPrompts: "全部 Prompt",
        summaryFilterFavorites: "筛选：仅看收藏",
        summaryFilterMostUsed: "筛选：仅看常用",
        summaryFilterRecentlyAdded: "筛选：仅看最近添加",
        summaryFilterRecentlyUsed: "筛选：仅看最近使用",
        summarySortSmart: "排序：智能推荐（收藏 > 最近使用 > 使用频率 > 创建时间）",
        summarySortLastUsed: "排序：最近使用在前",
        summarySortUsage: "排序：使用次数高在前",
        summarySortCreated: "排序：最近添加在前",
    ...
    en: {
        ...
        summaryAllPrompts: "All prompts",
        summaryFilterFavorites: "Filter: favorites only",
        summaryFilterMostUsed: "Filter: most used only",
        summaryFilterRecentlyAdded: "Filter: recently added only",
        summaryFilterRecentlyUsed: "Filter: recently used only",
        summarySortSmart: "Sort: smart ranking (favorite > recent use > frequency > created time)",
        summarySortLastUsed: "Sort: most recently used first",
        summarySortUsage: "Sort: highest usage first",
        summarySortCreated: "Sort: newest first",
