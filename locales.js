...
export const translations = {
    zh_CN: {
        ...
        recentlyAdded: "最近添加",
        recentlyUsed: "最近使用",
        viewSummarySmart: "默认显示全部，收藏和常用内容会更靠前",
        viewSummaryFavorites: "当前只显示已收藏的 Prompt",
        viewSummaryMostUsed: "当前显示使用过的 Prompt，常用的会更靠前",
        viewSummaryRecentUsed: "当前显示最近用过的 Prompt",
        viewSummaryRecentAdded: "当前显示你后来添加的 Prompt，新添加的会更靠前",
    ...
    en: {
        ...
        viewSummarySmart: "Shows everything, with favorites and frequently used prompts first",
        viewSummaryFavorites: "Shows only your favorited prompts",
        viewSummaryMostUsed: "Shows prompts you've used, with frequent ones first",
        viewSummaryRecentUsed: "Shows prompts you used recently",
        viewSummaryRecentAdded: "Shows prompts you added later, with newer ones first",
