...
export const translations = {
    zh_CN: {
        ...
        tabPaste: "粘贴文本",
        tabUrl: "从 URL 导入",
        pasteHint: "支持 Prompt Ark JSON、CSV；Markdown 和普通文本按单条 Prompt 导入",
        pastePlaceholder: "在此粘贴内容...",
        urlHint: "支持 md/json/csv/txt/yaml/yml 文件 URL；GitHub 仓库会扫描这组文件，其中 md/txt/yaml/yml 按单文件单 Prompt 导入",
        scan: "扫描",
        confirmImportBtn: "导入",
        deepScan: "深度扫描",
        minScore: "最低分",
    ...
    en: {
        ...
        pasteHint: "Supports Prompt Ark JSON and CSV; Markdown and plain text import as one prompt",
        pastePlaceholder: "Paste content here...",
        urlHint: "Supports md/json/csv/txt/yaml/yml URLs; GitHub repos scan that set, and md/txt/yaml/yml import as one prompt each",
        scan: "Scan",
