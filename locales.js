...
export const translations = {
    zh_CN: {
        ...
        tabPaste: "直接粘贴",
        tabUrl: "链接导入",
        pasteHint: "适合导入一条提示词，或粘贴 Prompt Ark 导出内容。普通文本默认按 1 条导入。",
        pastePlaceholder: "粘贴一段提示词，或 Prompt Ark 导出的内容",
        urlHint: "请输入文件链接，或 GitHub 仓库/目录链接。普通网页链接暂不支持。",
        urlPlaceholder: "https://github.com/owner/repo 或文件直链",
        optionalTag: "可选",
        scan: "扫描",
        confirmImportBtn: "导入",
        deepScan: "深度扫描",
    ...
    en: {
        ...
        tabPaste: "Paste",
        tabUrl: "Import Link",
        pasteHint: "Best for one prompt or content exported from Prompt Ark. Plain text imports as a single prompt.",
        pastePlaceholder: "Paste a prompt or Prompt Ark export",
        urlHint: "Use a file link or a GitHub repo/folder link. Regular webpage URLs are not supported.",
        urlPlaceholder: "https://github.com/owner/repo or direct file URL",
